        ...
        <div class="col-lg-12">
                    ...
                    <div class="card card col-12 border-info">
                        <div class="card-header bg-transparent border-success d-flex">
                            ...
                            <h3 class="card-title ml-auto"><a class="btn bg-cyan" href="{{route('usuario_crear')}}"><i class="fas fa-plus-circle"></i>Nuevo</a></h3>
                        </div>
                        <div class="card-body"  > 
                            <table id="usuarios" class="table emojionearea display responsive nowrap" width="100%"> 
                                <thead class="bg-cyan">
                                    <th width="5%" >#</th>
