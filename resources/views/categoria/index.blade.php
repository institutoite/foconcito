        ...
        <div class="row">
            <div class="col-lg-12">  
                <div class="card-header border-success d-flex mt-3">
                    ...
                    <h3 class="card-title ml-auto"><a class="btn bg-cyan" href="{{route('categoria_crear')}}"><i class="fas fa-plus-circle"></i>Nuevo</a></h3>
                </div>
                <div class="card-body"> 
                    <table id="categorias" class="table table-hover table-bordered table-striped">
                        <thead class="bg-cyan">
