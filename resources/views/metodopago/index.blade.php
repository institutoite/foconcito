...
@section('contenido')
    @can('metodopago_listar')
    <div class="row">
            <div class="col-lg-12">  
                <div class="card-header border-success d-flex mt-3">
                    <h3 class="card-title">METODO DE PAGO</h3>
                    <h3 class="card-title ml-auto"><a class="btn bg-cyan" href="{{route('metodopago_crear')}}"><i class="fas fa-plus-circle"></i>Nuevo</a></h3>
                </div>
                <div class="card-body"> 
                    <table id="metodos" class="table table-hover table-bordered table-striped display responsive nowrap" style="width:100%">
                        <thead class="bg-cyan">
                            <th width="10px" >#</th>
                            <th>Método</th>
