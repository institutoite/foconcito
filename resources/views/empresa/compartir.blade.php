        ...
        <div class="row">
            <div class="col-lg-12">  
                <div class="card-header border-success d-flex mt-3">
                    <h3 class="card-title">COMPARTIR EMPRESA: <strong> {{ $empresa->empresa }}</strong> </h3>
                </div>
                        ...
                        <tbody>
                                @foreach ($telefonos as $telefono)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('empresa_share',['prefijo'=>$telefono->prefijo,'numero'=>$telefono->numero,'id'=>$empresa->id])}}" class="btn-accion-tabla tooltipsC" title="Compartir tu empresa con este cliente">
